...
if ($result->num_rows > 0) {
    ...
    if ($mysqli->query($sql)) {
        ...
        // Instead of redirecting to profile.php, stay on the sign-up page
        $_SESSION['register_success'] = true; // Flag to show registration success
        header("location: index.php?register=success"); // Redirect back to the sign-up page with a success message
    } else {
